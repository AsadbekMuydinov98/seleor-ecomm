...
import { emailSchema, loginSchema, registerSchema, verifyOtpSchema } from "@/lib/validation"
...
export const verifyOtp = actionClient.schema(verifyOtpSchema).action<ReturnActionType>(async ({ parsedInput }) => {
